...
This application demonstrates how to use the Cloudant NoSQL DB and Workload Scheduler services, with the 'Liberty for Java™' runtime on IBM Cloud.


Files

The Java Cloudant Web Starter application contains the following contents:
